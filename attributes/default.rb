...
# default["tomee"]["keystore_password"] = nil
# default["tomee"]["truststore_password"] = nil
default['tomee']['truststore_file'] = nil
default['tomee']['truststore_type'] = 'jks'
...
default['tomee']['config_dir'] = '/opt/tomee/conf'
default['tomee']['log_dir'] = '/opt/tomee/logs'
default['tomee']['tmp_dir'] = '/opt/tomee/temp'
default['tomee']['work_dir'] = '/opt/tomee/work'
default['tomee']['context_dir'] = "#{node["tomee"]["config_dir"]}/Catalina/localhost"
default['tomee']['webapp_dir'] = '/opt/tomee/webapps'
default['tomee']['keytool'] = 'keytool'
default['tomee']['lib_dir'] = "#{node["tomee"]["home"]}/lib"
default['tomee']['endorsed_dir'] = "#{node["tomee"]["home"]}/lib/endorsed"
